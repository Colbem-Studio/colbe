...
export function MarketingHero() {
  return (
    <section className="w-full px-6 pb-16 pt-24 text-center md:pt-32">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mx-auto mt-10 max-w-xl rounded-[15px] border border-border bg-card p-6 shadow-lg md:p-8">
