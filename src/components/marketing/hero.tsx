...
export function MarketingHero() {
  return (
    <section className="relative bg-gradient-to-br from-primary via-primary/70 to-secondary px-6 pb-16 pt-20 text-center md:pt-28">
        <h1
          className="font-mono text-4xl font-bold uppercase leading-tight tracking-tight text-white md:text-6xl"
        ...
        <div className="mx-auto mt-16 max-w-xl rounded-[15px] bg-card p-6 shadow-lg md:p-8">
